...
export interface ApiBlogBlog extends Schema.SingleType {
  ...
  attributes: {
    ...
    baseContent: Attribute.Component<'layout.page-base-architecture'>;
...
export interface ApiCoursePageCoursePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    basePage: Attribute.Component<'layout.page-base-architecture'>;
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    header: Attribute.Component<'layout.header-section'>;
    servicesPreview: Attribute.Component<'layout.services'>;
    featuredCourse: Attribute.Component<'layout.featured-course'>;
    postsSelection: Attribute.Component<'blog.post-selections'>;
    dynamicSingleContent: Attribute.DynamicZone<
      ['layout.newsletter-form', 'layout.mission-component']
    >;
    homeSeo: Attribute.Component<'seo.seo-information'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
